  ...
  return (
    <div style={{
      ...
      <div style={{ maxHeight: "352px", overflowY: "auto", padding: "20px 24px", display: "flex", flexDirection: "column", gap: "12px" }}>
        {mheItems.map((m) => (
          <div key={m.id} style={{ border: "1px solid var(--w-border)", borderRadius: 8, padding: "8px 13px", display: "flex", flexDirection: "column", gap: "8px", background: "var(--w-bg)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 0" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: 12, lineHeight: "16px", color: "var(--w-text-1)", whiteSpace: "nowrap" }}>{m.id}</span>
                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 10, lineHeight: "15px", color: "var(--w-text-2)", whiteSpace: "nowrap" }}>Last Inspection: {m.lastInspection}</span>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 0, padding: "6px 0" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 1, flex: 1 }}>
                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: 11, lineHeight: "14.3px", color: "var(--w-text-1)" }}>{String(m.done).padStart(2, "0")}</span>
                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 10, lineHeight: "15px", color: "var(--w-text-2)", whiteSpace: "nowrap" }}>Inspection Done</span>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 1, flex: 1 }}>
                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: 11, lineHeight: "14.3px", color: "var(--w-text-1)" }}>{String(m.skipped).padStart(2, "0")}</span>
                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 10, lineHeight: "15px", color: "var(--w-text-2)", whiteSpace: "nowrap" }}>Inspection Skipped</span>
              </div>
            </div>

            {/* Row 3: severity dots */}
            <div style={{ borderTop: "1px solid var(--w-border)", padding: "8px 0", display: "flex", alignItems: "center", gap: 6 }}>
              {([["#e11d48", "Red", m.red], ["#f59e0b", "Amber", m.amber], ["#16a34a", "Green", m.green]] as [string, string, number][]).map(([color, label, val]) => (
                <div key={label} style={{ display: "flex", gap: "4px", alignItems: "center" }}>
                  ...
                  <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 400, fontSize: 10, lineHeight: "15px", color: "var(--w-text-2)", whiteSpace: "nowrap" }}>{label} {val}</span>
                </div>
              ))}
            </div>
          </div>
