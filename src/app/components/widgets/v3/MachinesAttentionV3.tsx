        ...
        {mheItems.map((m) => (
          <div key={m.id} style={{ border: "1px solid #e2e8f0", borderRadius: 8, padding: "8px 13px", display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ flex: 1 }} />
              <div style={{ display: "flex", alignItems: "center", gap: 4, height: 26, padding: "0 13px", background: "#eef2ff", border: "1px solid #e0e7ff", borderRadius: 999, flexShrink: 0 }}>
                <img src={batteryIcon} alt="" style={{ width: 14, height: 14 }} />
                <span style={{ fontFamily: "Inter, sans-serif", fontWeight: 500, fontSize: 10, lineHeight: "16px", color: "#1e40af", whiteSpace: "nowrap" }}>Most Issues: {m.mostIssues}</span>
              </div>
            </div>
