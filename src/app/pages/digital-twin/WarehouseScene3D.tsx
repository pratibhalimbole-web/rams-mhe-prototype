...
const MHE_VEHICLES = [
  ...
  { id: "MHE-03", label: "MHE 03", type: "Electric Pallet Jack", color: "#8b5cf6", path: [[-8,0,5],[2,0,5],[2,0,10],[-8,0,10],[-8,0,5]]              as [number,number,number][] },
...
export function WarehouseScene({
  ...
  return (
    <>
      ...
      <directionalLight position={[0, 8, 30]} intensity={0.18} color="#fff8e0" />
