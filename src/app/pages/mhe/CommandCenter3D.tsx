...
const INITIAL_ASSIGNMENTS: TaskAssignment[] = [
  ...
  },
  {
    id: "ta-init-2",
    taskId: "pallet-pick",
    taskName: "Pallet Pick → Bay A-12",
    mheId: "MHE-01",
    status: "deviated",
    plannedPath: [[-20,0,-5],[-12,0,-5],[-12,0,2]],
    actualPath:  [[-20,0,-5],[-16,0,-5],[-16,0,0],[-12,0,0],[-12,0,2]],
    deviationZone: { cx: -16, cz: -2, w: 8, d: 7 },
    metrics: {
      plannedDist: 11, actualDist: 17,
      plannedTime: 1.6, actualTime: 2.8,
      batteryPlanned: 1.1, batteryActual: 1.9,
      efficiencyScore: 71,
      operatorScore: { before: 79, after: 68 },
      issues: ["Aisle blocked — rerouted", "+1.2 min delay"],
    },
  },
  {
    id: "ta-init-3",
    taskId: "replenish",
    taskName: "Replenishment → Row B",
    mheId: "MHE-02",
    status: "completed",
    plannedPath: [[4,0,-12],[16,0,-12],[16,0,-7]],
    actualPath:  [[4,0,-12],[16,0,-12],[16,0,-7]],
    deviationZone: { cx: 10, cz: -9.5, w: 12, d: 5 },
    metrics: {
      plannedDist: 17, actualDist: 17,
      plannedTime: 2.4, actualTime: 2.2,
      batteryPlanned: 1.8, batteryActual: 1.6,
      efficiencyScore: 94,
      operatorScore: { before: 88, after: 91 },
      issues: [],
    },
  },
  {
    id: "ta-init-4",
    taskId: "order-pick",
    taskName: "Order Pick · Bay D-08",
    mheId: "MHE-04",
    status: "deviated",
    plannedPath: [[2,0,-14],[18,0,-14],[18,0,-8]],
    actualPath:  [[2,0,-14],[12,0,-14],[12,0,-11],[18,0,-11],[18,0,-8]],
    deviationZone: { cx: 10, cz: -11, w: 14, d: 6 },
    metrics: {
      plannedDist: 22, actualDist: 29,
      plannedTime: 3.1, actualTime: 4.4,
      batteryPlanned: 2.2, batteryActual: 3.1,
      efficiencyScore: 58,
      operatorScore: { before: 75, after: 61 },
      issues: ["Cross-traffic delay", "Wrong zone entered", "+1.3 min delay"],
    },
  },
  {
    id: "ta-init-5",
    taskId: "standby",
    taskName: "Charging · Await Next Task",
    mheId: "MHE-05",
    status: "completed",
    plannedPath: [[-22,0,3],[-14,0,3],[-14,0,7]],
    actualPath:  [[-22,0,3],[-14,0,3],[-14,0,7]],
    deviationZone: { cx: -18, cz: 5, w: 8, d: 4 },
    metrics: {
      plannedDist: 10, actualDist: 10,
      plannedTime: 1.4, actualTime: 1.4,
      batteryPlanned: 0.9, batteryActual: 0.9,
      efficiencyScore: 98,
      operatorScore: { before: 90, after: 92 },
      issues: [],
    },
  },
  {
    id: "ta-init-6",
    taskId: "pallet-move",
    taskName: "Pallet Move → QC Station",
    mheId: "MHE-06",
    status: "deviated",
    plannedPath: [[-2,0,-14],[10,0,-14],[10,0,-8]],
    actualPath:  [[-2,0,-14],[6,0,-14],[6,0,-11],[10,0,-11],[10,0,-8]],
    deviationZone: { cx: 4, cz: -11, w: 12, d: 6 },
    metrics: {
      plannedDist: 20, actualDist: 26,
      plannedTime: 2.8, actualTime: 3.9,
      batteryPlanned: 2.0, batteryActual: 2.8,
      efficiencyScore: 67,
      operatorScore: { before: 81, after: 72 },
      issues: ["Speed limit zone exceeded", "Suboptimal route taken", "+1.1 min delay"],
    },
  },
];
