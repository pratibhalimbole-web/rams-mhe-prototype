import svgPaths from "./svg-wbl6pn6lij";
...
export default function RulesAndAction() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="RulesAndAction">
      <PrimitiveDiv />
    </div>
  );
}